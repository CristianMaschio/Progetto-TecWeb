	...
	<div id="content">
        <div class="title"><h2>Informazioni</h2></div>
            <div class="content">
				...
				<h4>Chi siamo</h4>
					Benvenuto nella Biglietteria <span lang="eng">Online</span>. Qui potrai prenotare il tuo posto in un ampia fascia di <a href="categorie.php">categorie</a> di eventi, come biglietti per musei, fiere o cinema. 
				...
				Ecco alcuni chiarimenti sulle terminologie utilizzate in questa piattaforma:
				<dl>
					<dt>Evento</dt>
				...
				<!-- TODO: vedere se è abbastnza chiara la differenza spettacolo/evento-->
					<span style="color:red">AGGIORNARE QUANDO ESISTERANNO LA RICERCA SPECIFICA E LA RICERCA PER SPETTACOLO, CON IMMAGINI</span>
				...
				<h4>Come prenotare un biglietto</h4>
					...
					Dopo aver effettuato una ricerca clicca sul nome dell'evento a cui vuoi partecipare per procedere alla prenotazione di un biglietto. Dopo aver cliccato ti si presenterà davanti una tabella contenente tutte le date disponibili. Clicca nel piccolo pulsante con scritto "Prenota" per assicurarti un posto.


				<h4>Come vedere ed annullare le tue prenotazioni di biglietti</h4>

					Clicca sul tuo <span lang="eng">username</span> in alto a destra sotto la barra di ricerca: ti si aprirà la tua pagina personale. Qui potrai vedere le tue prenotazioni. Se ne vuoi cancellare qualcuna ti basterà cliccare il pulsante "Annulla prenotazione" nella tabella.
