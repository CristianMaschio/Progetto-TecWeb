<?php
    ...
    register('id_mod');
    $id_luogo_spettacolo =select("SELECT luogo_id FROM spettacoli WHERE id=$id_mod");# � la varabile che indica l'id del luogo in cui sar� ospitato lo spettacolo
...
<html>
    ...
    <body>
        ...
        <div class="panel">
            ...
            <?php if($_SESSION['user_tipo'] != 'L'): ?> <!-- controllo che sia un utente admin o operatore, altrimentinon pu� modificare il luogo -->
            Luogo <select name="luogo_s" required>
                ...
                ?>
            <?php else: ?>
            <!-- se un amministratore di luogo richiede di modificare uno spettacolo non potr� modificare il luogo in cui si svolge -->
